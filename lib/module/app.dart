...
10002:文件第一次重新启动或者用户不小心删除的Config.conf 文件
*/
/*
错误
...
10010：导出Excel过程出问题，可能没有权限或者没有数据文件，重新打开或重新安装试试看，保证给本地写入权限
10011：导入Excel过程出问题，可能没有权限或者数据文件损坏，重新打开或重新安装试试看，保证给本地读入权限
10012：导出ZIP压缩包时出问题，路径不存在或者没有权限，建议给权限或重装

10013：写入配置文件失败，可能没有权限或者数据文件损坏，重新打开或重新安装试试看，保证给本地写入权限
